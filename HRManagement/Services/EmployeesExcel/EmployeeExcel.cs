...
namespace HRManagement.Services.EmployeesExcel
{
    public class EmployeeExcel : IEmployeeExcel
    {
        ...
        public async Task ExportEmployeesToExcel(string filePath)
        {
            ...
            //////////////............. Trying to code to save the file in OneDrive using Microsoft Graph API

            //string clientId = "";
            //string tenantId = "";
            //string clientSecret = ""; // For web apps
            ...
            //string targetPath = "/EmployeesDataExcel.xlsx"; // Path in OneDrive
            ...
            //string graphUri = $"https://graph.microsoft.com/v1.0/me/drive/root:{targetPath}:/content";
            //var response = await httpClient.PutAsync(graphUri, content);
